    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
      <div>
        ...
        <div className="grid grid-cols-3 h-36 mt-5 gap-3">
          {["maps-1.png", "maps-2.png", "maps-3.png"].map((item) => (
            <div className="relative rounded-md overflow-hidden" key={item}>
              <Image
                src={`/images/${item}`}
                alt="CCTV"
                className="w-full h-full object-cover absolute"
                ...
                height={200}
              />
              <div className="absolute h-full text-sm bg-black w-full text-white px-3 py-2 bg-opacity-30 flex items-start flex-col justify-end">
                <div className="text-sm">Lokasi</div>
                <div className="font-semibold text-base">Lorem, ipsum dolor.</div>
              </div>
            </div>
          ))}
        </div>
        <div className="flex gap-4 mt-3">
          <Link href="/" className="w-1/2 bg-deep-teal bg-opacity-50 border border-white border-opacity-30 h-16 flex items-center justify-center text-cyan-neon text-lg gap-1 rounded-md">
            <MdDashboard className="text-red-700 text-2xl"/> Tata Letak
          </Link>
          <Link href="/peta" className="w-1/2 bg-deep-teal bg-opacity-50 border border-white border-opacity-30 h-16 flex items-center justify-center text-cyan-neon text-lg gap-1 rounded-md">
