  ...
  return (
    <DateSegmentRa
      className={composeRenderProps(className, (className) =>
        cn(
          `
            text-foreground inline-flex rounded px-0.5 caret-transparent outline-hidden data-[type=literal]:text-mutedForeground/70 data-[type=literal]:px-0
            data-placeholder:text-mutedForeground/70
