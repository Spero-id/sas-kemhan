    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'size-8 text-mutedForeground/80 hover:text-foreground p-0',
        ),
        button_next: cn(
          buttonVariants({ variant: 'ghost' }),
          'size-8 text-mutedForeground/80 hover:text-foreground p-0',
        ),
        weekday: 'size-8 p-0 text-xs font-medium text-mutedForeground/80',
        day_button:
        ...
        outside: 'text-mutedForeground data-selected:bg-accent/50 data-selected:text-mutedForeground',
        hidden: 'invisible',
        week_number: 'size-8 p-0 text-xs font-medium text-mutedForeground/80',
        ...classNames,
      }}
      components={{
        Chevron: (props) => {
